...
enum KeyList {
	...
	GDKEY_SHIFT_L = SPKEY | 0x102,
	GDKEY_SHIFT_R = SPKEY | 0x103,
	GDKEY_CONTROL = SPKEY | 0x16,
	GDKEY_CONTROL_L = SPKEY | 0x106,
	GDKEY_CONTROL_R = SPKEY | 0x107,
	GDKEY_META = SPKEY | 0x17,
	GDKEY_META_L = SPKEY | 0x104,
	GDKEY_META_R = SPKEY | 0x105,
	GDKEY_ALT = SPKEY | 0x18,
	GDKEY_ALT_L = SPKEY | 0x100,
	GDKEY_ALT_R = SPKEY | 0x101,
...
static struct key_map map[] = {
	...
	{ GDKEY_SHIFT_L, KEY_LEFTSHIFT },
	{ GDKEY_SHIFT_R, KEY_RIGHTSHIFT },
	{ GDKEY_CONTROL, KEY_LEFTCTRL },
	{ GDKEY_CONTROL_L, KEY_LEFTCTRL },
	{ GDKEY_CONTROL_R, KEY_RIGHTCTRL },
	{ GDKEY_META, KEY_LEFTMETA },
	{ GDKEY_META_L, KEY_LEFTMETA },
	{ GDKEY_META_R, KEY_RIGHTMETA },
	{ GDKEY_ALT, KEY_LEFTALT },
	{ GDKEY_ALT_L, KEY_LEFTALT },
	{ GDKEY_ALT_R, KEY_RIGHTALT },
